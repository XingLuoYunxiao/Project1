...
import { MapDemo } from "@bundle:com.example.ictproject/default@Travel/ets/pages/MapDemo";
export const attractions: Attraction[] = [
    new Attraction(1, "长城", { "id": 50331698, "type": 20000, params: [], "bundleName": "com.example.ictproject", "moduleName": "default" }),
    new Attraction(2, "故宫", { "id": 50331674, "type": 20000, params: [], "bundleName": "com.example.ictproject", "moduleName": "default" }),
    new Attraction(3, "大唐不夜城", { "id": 50331675, "type": 20000, params: [], "bundleName": "com.example.ictproject", "moduleName": "default" }),
];
export class TravelStartPage extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Navigation.debugLine("features/Travel/src/main/ets/pages/TravelStartPage.ets(24:5)", "travel");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("features/Travel/src/main/ets/pages/TravelStartPage.ets(25:7)", "travel");
            Column.width('95%');
            Column.height('100%');
        ...
        }, Column);
        {
            this.observeComponentCreation2((elmtId, isInitialRender) => {
                if (isInitialRender) {
                    ...
                    //搜索栏
                    SearchHeader(this, {}, undefined, elmtId, () => { }, { page: "features/Travel/src/main/ets/pages/TravelStartPage.ets", line: 27, col: 9 });
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            //轮播图
            Swiper.create();
            Swiper.debugLine("features/Travel/src/main/ets/pages/TravelStartPage.ets(30:9)", "travel");
            //轮播图
            ...
            const forEachItemGenFunction = _item => {
                const item = _item;
                {
                    ...
                    const itemCreation2 = (elmtId, isInitialRender) => {
                        ...
                        ListItem.width('100%');
                        ListItem.height(230);
                        ListItem.debugLine("features/Travel/src/main/ets/pages/TravelStartPage.ets(32:13)", "travel");
                    };
        ...
        }, __Common__);
        {
            this.observeComponentCreation2((elmtId, isInitialRender) => {
                if (isInitialRender) {
                    let componentCall = new 
                    //旅游分类
                    Classification(this, {}, undefined, elmtId, () => { }, { page: "features/Travel/src/main/ets/pages/TravelStartPage.ets", line: 46, col: 9 });
                    ViewPU.create(componentCall);
                    let paramsLambda = () => {
                        return {};
                    };
        ...
        }, __Common__);
        {
            this.observeComponentCreation2((elmtId, isInitialRender) => {
                if (isInitialRender) {
                    let componentCall = new 
                    //附近景点
                    NearbyAttraction(this, {}, undefined, elmtId, () => { }, { page: "features/Travel/src/main/ets/pages/TravelStartPage.ets", line: 51, col: 9 });
                    ViewPU.create(componentCall);
                    let paramsLambda = () => {
                        return {};
                    };
                ...
                this.ifElseBranchUpdateFunction(0, () => {
                    {
                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                            if (isInitialRender) {
                                let componentCall = new FamousPlacePage(this, {}, undefined, elmtId, () => { }, { page: "features/Travel/src/main/ets/pages/TravelStartPage.ets", line: 69, col: 7 });
                                ViewPU.create(componentCall);
                                let paramsLambda = () => {
                                    return {};
                                };
                ...
                this.ifElseBranchUpdateFunction(1, () => {
                    {
                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                            if (isInitialRender) {
                                let componentCall = new LoadingAnimation(this, {}, undefined, elmtId, () => { }, { page: "features/Travel/src/main/ets/pages/TravelStartPage.ets", line: 71, col: 7 });
                                ViewPU.create(componentCall);
                                let paramsLambda = () => {
                                    return {};
                                };
                ...
                this.ifElseBranchUpdateFunction(2, () => {
                    {
                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                            if (isInitialRender) {
                                let componentCall = new AttractionDetailPage(this, {}, undefined, elmtId, () => { }, { page: "features/Travel/src/main/ets/pages/TravelStartPage.ets", line: 73, col: 7 });
                                ViewPU.create(componentCall);
                                let paramsLambda = () => {
                                    return {};
                                };
                ...
                this.ifElseBranchUpdateFunction(3, () => {
                    {
                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                            if (isInitialRender) {
                                let componentCall = new MapDemo(this, {}, undefined, elmtId, () => { }, { page: "features/Travel/src/main/ets/pages/TravelStartPage.ets", line: 75, col: 7 });
                                ViewPU.create(componentCall);
                                let paramsLambda = () => {
                                    return {};
                                };
    ...
    AttractionItem(attraction: Attraction, parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Stack.create();
            Stack.debugLine("features/Travel/src/main/ets/pages/TravelStartPage.ets(81:5)", "travel");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Image.debugLine("features/Travel/src/main/ets/pages/TravelStartPage.ets(83:7)", "travel");
            Image.width('100%');
            Image.height(200);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("features/Travel/src/main/ets/pages/TravelStartPage.ets(87:7)", "travel");
            Text.fontSize(18);
            Text.padding({ top: 5 });
            Text.padding(5);
