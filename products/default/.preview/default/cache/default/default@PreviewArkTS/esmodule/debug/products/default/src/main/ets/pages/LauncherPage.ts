...
class LauncherPage extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Column.debugLine("products/default/src/main/ets/pages/LauncherPage.ets(54:5)", "default");
            Column.height('100%');
            Column.width('100%');
        }, Column);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Image.create({ "id": 50331769, "type": 20000, params: [], "bundleName": "com.example.ictproject", "moduleName": "default" });
            Image.debugLine("products/default/src/main/ets/pages/LauncherPage.ets(55:7)", "default");
