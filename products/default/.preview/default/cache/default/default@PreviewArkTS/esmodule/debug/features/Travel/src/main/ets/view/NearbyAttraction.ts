...
const nearbyAttractions: Attraction[] = [
    new Attraction(4, "秦始皇兵马俑博物馆", { "id": 50331702, "type": 20000, params: [], "bundleName": "com.example.ictproject", "moduleName": "default" }, "秦始皇兵马俑博物馆位于陕西省西安市，是中国最著名的考古遗址之一，展示了秦始皇的陵墓及其壮观的兵马俑军队。"),
    new Attraction(5, "大雁塔", { "id": 50331695, "type": 20000, params: [], "bundleName": "com.example.ictproject", "moduleName": "default" }, "大雁塔是唐代著名的佛塔，位于陕西省西安市，是玄奘法师为保存从印度带回的佛经而建。"),
    new Attraction(6, "西安城墙", { "id": 50331697, "type": 20000, params: [], "bundleName": "com.example.ictproject", "moduleName": "default" }, "西安城墙是中国现存规模最大、保存最完整的古代城垣，是明代初年在唐长安城的基础上扩建而成的。"),
    new Attraction(7, "钟楼", { "id": 50331693, "type": 20000, params: [], "bundleName": "com.example.ictproject", "moduleName": "default" }, "钟楼位于西安市中心，是明代建筑的典范，历史上用于晨钟暮鼓，现在是西安的标志性建筑之一。"),
    new Attraction(3, "大唐不夜城", { "id": 50331675, "type": 20000, params: [], "bundleName": "com.example.ictproject", "moduleName": "default" }, "大唐不夜城位于陕西省西安市，是一个集文化、旅游、商业于一体的综合性旅游景区，以唐代皇家园林为主题，展现了盛唐时期的繁荣景象。"),
];
//定义一个景点距离数组
