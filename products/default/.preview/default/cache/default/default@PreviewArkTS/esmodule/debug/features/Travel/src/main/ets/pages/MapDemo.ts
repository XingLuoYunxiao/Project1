...
export class MapDemo extends ViewPU {
    ...
    setInitiallyProvidedValue(params: MapDemo_Params) {
    ...
    updateStateVars(params: MapDemo_Params) {
    }
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            NavDestination.create(() => {
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Stack.create();
                    Stack.debugLine("features/Travel/src/main/ets/pages/MapDemo.ets(56:7)", "travel");
                    Stack.height('100%');
                }, Stack);
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    __Common__.create();
                ...
                }, __Common__);
                {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        if (isInitialRender) {
                            ...
                            MapComponent(this, { mapOptions: this.mapOptions, mapCallback: this.callback }, undefined, elmtId, () => { }, { page: "features/Travel/src/main/ets/pages/MapDemo.ets", line: 58, col: 9 });
                ...
                __Common__.pop();
                Stack.pop();
            }, { moduleName: "default", pagePath: "features/Travel/src/main/ets/pages/MapDemo" });
            NavDestination.debugLine("features/Travel/src/main/ets/pages/MapDemo.ets(55:5)", "travel");
        }, NavDestination);
        NavDestination.pop();
    }
    rerender() {
