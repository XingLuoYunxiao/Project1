        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            NavDestination.create(() => {
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    ...
                    Column.width('100%');
                    Column.height('100%');
                    Column.backgroundImage({ "id": 50331704, "type": 20000, params: [], "bundleName": "com.example.ictproject", "moduleName": "default" });
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    ...
                    if (this.currentStep < this.steps.length - 1) {
                        ...
                        this.ifElseBranchUpdateFunction(1, () => {
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                Image.create({ "id": 50331676, "type": 20000, params: [], "bundleName": "com.example.ictproject", "moduleName": "default" });
