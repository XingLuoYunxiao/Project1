                ...
                const item = _item;
                {
                    ...
                    const observedDeepRender = () => {
                        this.observeComponentCreation2(itemCreation2, GridItem);
                        {
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                if (isInitialRender) {
                                    let componentCall = new EnablementItem(this, { enablementItem: item }, undefined, elmtId, () => { }, { page: "products/default/oh_modules/@ohos/quickstart/src/main/ets/view/EnablementView.ets", line: 31, col: 13 });
...
export class EnablementItem extends ViewPU {
    ...
    initialRender() {
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Image.create({ "id": -1, "type": -1, params: [this.enablementItem.imageSrc], "bundleName": "com.example.ictproject", "moduleName": "default" });
            Image.width('100%');
