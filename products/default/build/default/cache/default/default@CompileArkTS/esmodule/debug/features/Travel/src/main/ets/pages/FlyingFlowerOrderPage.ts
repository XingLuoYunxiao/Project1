...
import { ChatI } from "@bundle:com.example.ictproject/default@Travel/ets/model/ChatI";
...
export class FlyingFlowerOrderPage extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Navigation.create(new NavPathStack(), { moduleName: "default", pagePath: "features/Travel/src/main/ets/pages/FlyingFlowerOrderPage", isUserCreateStack: false });
                        ...
                        this.ifElseBranchUpdateFunction(0, () => {
                            {
                                ...
                                const deepRenderFunction = (elmtId, isInitialRender) => {
                                    ...
                                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                                        Image.create({ "id": 50331660, "type": 20000, params: [], "bundleName": "com.example.ictproject", "moduleName": "default" });
                        ...
                        this.ifElseBranchUpdateFunction(1, () => {
                            {
                                ...
                                const deepRenderFunction = (elmtId, isInitialRender) => {
                                    ...
                                    Text.pop();
                                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                                        Image.create({ "id": 50331661, "type": 20000, params: [], "bundleName": "com.example.ictproject", "moduleName": "default" });
                                        Image.size({ height: 50, width: 50 });
                                    }, Image);
                                    Row.pop();
                                    ListItem.pop();
