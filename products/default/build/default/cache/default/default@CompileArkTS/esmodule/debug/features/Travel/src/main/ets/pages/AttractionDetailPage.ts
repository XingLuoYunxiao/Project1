...
export class AttractionDetailPage extends ViewPU {
    constructor(parent, params, __localStorage, elmtId = -1, paramsLambda = undefined, extraInfo) {
        ...
        this.__attraction = new ObservedPropertyObjectPU(new Attraction(1, "null", { "id": 67108884, "type": 20000, params: [], "bundleName": "com.example.ictproject", "moduleName": "default" }), this, "attraction");
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            NavDestination.create(() => {
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Image.create({ "id": 67108900, "type": 20000, params: [], "bundleName": "com.example.ictproject", "moduleName": "default" });
                    Image.width(30);
                    Image.height(30);
                    Image.onClick(() => {
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    ...
                    if (this.voice === false) {
                        this.ifElseBranchUpdateFunction(0, () => {
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                Image.create({ "id": 67108913, "type": 20000, params: [], "bundleName": "com.example.ictproject", "moduleName": "default" });
                                Image.width(30);
                                Image.height(30);
                        ...
                        this.ifElseBranchUpdateFunction(1, () => {
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                Image.create({ "id": 67108914, "type": 20000, params: [], "bundleName": "com.example.ictproject", "moduleName": "default" });
                                Image.width(30);
                                Image.height(30);
                                Image.margin({ left: 15 });
                                Image.onClick(() => {
                ...
                Row.pop();
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Image.create({ "id": 67108895, "type": 20000, params: [], "bundleName": "com.example.ictproject", "moduleName": "default" });
                    Image.width('100%');
                    Image.height(300);
