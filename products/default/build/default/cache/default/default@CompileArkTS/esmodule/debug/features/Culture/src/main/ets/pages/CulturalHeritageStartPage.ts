...
import { FlyingFlowerOrderPage } from "@bundle:com.example.ictproject/default@Culture/ets/pages/FlyingFlowerOrderPage";
import { ttf } from "@bundle:com.example.ictproject/default@Culture/ets/util/ttf";
import { tsetMasterPieceIArr } from "@bundle:com.example.ictproject/default@Culture/ets/model/MasterpieceI";
import type { MasterpieceI } from "@bundle:com.example.ictproject/default@Culture/ets/model/MasterpieceI";
import { tsetAncientGamesIArr } from "@bundle:com.example.ictproject/default@Culture/ets/model/AncientGamesI";
import type { AncientGames } from "@bundle:com.example.ictproject/default@Culture/ets/model/AncientGamesI";
export class CulturalHeritageStartPage extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Navigation.create(this.travelPathStack, { moduleName: "default", pagePath: "features/Culture/src/main/ets/pages/CulturalHeritageStartPage", isUserCreateStack: true });
                ...
                this.ifElseBranchUpdateFunction(2, () => {
                    {
                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                            if (isInitialRender) {
                                let componentCall = new FlyingFlowerOrderPage(this, {}, undefined, elmtId, () => { }, { page: "features/Culture/src/main/ets/pages/CulturalHeritageStartPage.ets", line: 116, col: 7 });
