...
const int32_t MEDIA_AVATAR1 = 0x0300000c;
const int32_t MEDIA_AVATAR2 = 0x0300000d;
const int32_t MEDIA_AVATAR_ICON = 0x0200003c;
const int32_t MEDIA_AVATOR = 0x0300000a;
const int32_t MEDIA_BACKGROUND = 0x01000006;
const int32_t MEDIA_CARD = 0x0200003d;
const int32_t MEDIA_CHECK = 0x03000008;
...
const int32_t MEDIA_GUGONG = 0x03000000;
const int32_t MEDIA_GUGONG_MAP = 0x0300000b;
const int32_t MEDIA_GUIDE_ICON = 0x03000006;
const int32_t MEDIA_HOTEL_ICON = 0x03000007;
...
const int32_t MEDIA_LESHANDAFO = 0x03000001;
const int32_t MEDIA_LIST = 0x0200004f;
const int32_t MEDIA_LOAD_BACKGROUND = 0x03000009;
const int32_t MEDIA_LOCATION_ICON = 0x0200006f;
const int32_t MEDIA_LOGO = 0x02000062;
const int32_t MEDIA_MIAOSHA = 0x02000050;
const int32_t MEDIA_MOGAO = 0x03000002;
...
const int32_t MEDIA_QINSHIHUANGLIN = 0x03000003;
...
const int32_t MEDIA_TIANTAN = 0x03000004;
const int32_t MEDIA_YIHEYUAN = 0x03000005;
